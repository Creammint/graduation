            ...
            function showWelcome() {
                ...
                document.getElementsByClassName("announcement_content")[0].innerHTML =
                    ...
                    <p style = "text-align: center; ">
                        <a target="_blank" rel="noopener" style = "text-align: center;" href="https://www.creammint.cn/" title="此线路部署于阿里云">
                            <font color="#5ea6e5">creammint.cn</font>
                        </a> | 
                        <a target="_blank" rel="noopener" style = "text-align: center;" href="https://creammint.github.io/" title="此线路部署于Github">
                    ...
                    你距离Cream薄荷糖约有 <span style="color:#5ea6e5;font-weight:bold;">${dist}</span> 公里，${posdesc}
                    <br>
                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp 这里是我记录学习过程中的笔记、分享一些经验与想法。希望能够帮助到您！
